      ...
      <Footer>
        ...
        <FooterColumn
          ...
          points={[
            {
              icon: <Location />,
              title: `Unit 206- 9886 Torbram Rd \n
                  Bramtpon - ON \n
                  L6S 3 L9 `,
              href: "",
            },
...
export const UserLayout = (props) => {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <Header>
        <HeaderLeft />
        <HeaderRight {...props} handleLogout={handleToggle} />
      </Header>
      <div className="layout-section">
      ...
      <Popup trigger={toggle} setTrigger={handleToggle}>
...
const HeaderBfLogin = ({ children }) => {
  ...
  return (
    <div
      className={`layout-header-bf-login ${
        scrollPosition >= 10 ? "active" : ""
      }`}
    >
      {children}
    </div>
...
const HeaderRightBfLogin = (props) => {
  ...
  return (
    <div className={`layout-header-content-bf-login `}>
    ...
    <div className="footer-section">
      <div className="footer-inner-section">
        <div className="footer-column logo-column">
          ...
          <p>
            We work hard to make your Tax filing process as easy and hassle-free
            as possible
          </p>

          <ul>
            <li>
              <NavLink to="https://www.instagram.com/edutax_">
                <Insta />
              </NavLink>
            </li>
            <li>
              <NavLink to="https://www.facebook.com/profile.php?id=100047636203169&sfnsn=wiwspwa&mibextid=RUbZ1f">
                <Facebook />
              </NavLink>
            </li>
